...
const criarMentor = async (mentorAdd) => {
  try {
    await fetch("https://api-projeto-arnia.onrender.com/mentores", {
      method: "POST",
      headers: {
...
const buscarMentores = async (param = null) => {
  ...
  try {
    const mentoresApi = await fetch(
      `https://api-projeto-arnia.onrender.com/mentores${pesquisar}`
    );
...
const deletarMentor = async (id) => {
  try {
    console.log("deletou");
    await fetch(`https://api-projeto-arnia.onrender.com/mentores/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
...
const buscarMentorEditar = async (id) => {
  const resposta = await fetch(`https://api-projeto-arnia.onrender.com/mentores/${id}`);
...
const buscarMentoriasApi = async (param = null) => {
  ...
  try {
    const mentoriasSTR = await fetch(
      `https://api-projeto-arnia.onrender.com/mentorias${pesquisar}`
    );
...
const mandarMentoriaApi = async (mentoria) => {
  try {
    await fetch("https://api-projeto-arnia.onrender.com/mentorias", {
      method: "POST",
      headers: {
        Accept: "application/json, text/plain, */*",
        "Content-Type": "application/json",
...
const mentoriaEditApi = async (id) => {
  const resposta = await fetch(`https://api-projeto-arnia.onrender.com/mentorias/${id}`);
...
const salvarMentoriaEditada = async (mentoriaEditada) => {
  await fetch(`https://api-projeto-arnia.onrender.com/mentorias/${id}`, {
    method: "PUT",
    headers: {
      Accept: "application/json, text/plain, */*",
      "Content-Type": "application/json",
...
const buscarTurmas = async (param = null) => {
  ...
  try {
    const turmasApi = await fetch(`https://api-projeto-arnia.onrender.com/turmas${pesquisar}`);
...
const salvarTurma = async (novaTurma) => {
  try {
    await fetch("https://api-projeto-arnia.onrender.com/turmas", {
      method: "POST",
      headers: {
        Accept: "application/json, text/plain, */*",
        "Content-Type": "application/json",
...
const deletarTurma = async (id) => {
  try {
    console.log("deletou");
    await fetch(`https://api-projeto-arnia.onrender.com/turmas/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
...
const BuscaTurmaEditavel = async (id) => {
  const resposta = await fetch(`https://api-projeto-arnia.onrender.com/turmas/${id}`);
...
const mandarAlunoApi = async (aluno) => {
  try {
    await fetch("https://api-projeto-arnia.onrender.com/alunos", {
      method: "POST",
      headers: {
        Accept: "application/json, text/plain, */*",
        "Content-Type": "application/json",
...
const buscarAlunosApi = async (param = null) => {
  ...
  try {
    const alunos = await fetch(`https://api-projeto-arnia.onrender.com/alunos${pesquisar}`);
...
const deletarAluno = async (id) => {
  try {
    await fetch(`https://api-projeto-arnia.onrender.com/alunos/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
...
const alunoEditApi = async (id) => {
  const resposta = await fetch(`https://api-projeto-arnia.onrender.com/alunos/${id}`);
